...
export function GridSmallBackground({ children }) {
  return (
    <div className=" w-full dark:bg-black bg-white  dark:bg-grid-small-white/[0.2] bg-grid-small-black/[0.2] relative flex items-center justify-center">
      <div className="absolute pointer-events-none inset-0 flex items-center justify-center dark:bg-black/[0.6] bg-white [mask-image:radial-gradient(ellipse_at_center,transparent_20%,black)]"></div>
      <div className="p-24 bg-clip-text text-transparent bg-gradient-to-b from-neutral-200 to-neutral-500">
        {children}
      </div>
    </div>
  );
